...
taskRouter.post("/addtask", authMiddleware, validateTaskReq, taskController.addTask);

taskRouter.put("/edittask/:id", authMiddleware, validateEditTaskReq, taskController.editTask);
